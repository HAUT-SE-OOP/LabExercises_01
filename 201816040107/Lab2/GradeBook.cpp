...
GradeBook::GradeBook( string course, string instructor )//构造函数定义； 
{
...
void GradeBook::setInstructorName(string name1)
{
...
void GradeBook::displayMessage()
{
   ...
   /* write code to output the instructor's name */
         cout<<"this Course is Present by："<<getinstructorName()<<"!"
        << endl;
