...
{
    Complex sum;
   sum.realPart = realPart + right.realPart;
   sum.imaginaryPart = imaginaryPart + right.imaginaryPart;
   return sum;
...
{
    Complex sub;
   sub.realPart = realPart - right.realPart;
   sub.imaginaryPart = imaginaryPart - right.imaginaryPart;
   return sub;
