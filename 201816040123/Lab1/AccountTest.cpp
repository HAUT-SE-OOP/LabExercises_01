...
int main()
{
   ...
   int cunAmount; // stores withdrawal amount read from user

   cout << "\nEnter deposit amount for account1: "; // prompt
   cin >> cunAmount; // obtain user input
   cout << "\naddition " << cunAmount
      << " from account1 balance\n\n";
   account1.credit(cunAmount);/* write code to withdraw money from account1 */
   ...
   cout << "\naddition " << cunAmount
      << " from account1 balance\n\n";
   account2.credit(cunAmount);/* write code to withdraw money from account1 */
