...
int main()
{
   ...
   double addition = sc.add( a, b );/* Write a line that adds a and b through your SimpleCalculator
   ...
   double division = sc.divide( a, b );/* Write a line that divides a and b through the
