...
void Account::debit(int amount)
{
    if(balance>=amount)
    {
        balance-=amount;   //if balance is bigger than amount,balance minus amount;
    }
    else
        cout<<"Deit amount exceeded account balance."; //if balance is less than amount,output prompt;
}
