...
void Date::NextDay()
{
    if(day==monthDays()&&month!=12)//if it's the end of the month, but not the end of the year
    {
        day=1;                    //Assign day to 1
        month=month+1;            //Increase the value of month by 1

    }
    else if(month==12&&day==monthDays())//if it's the end of the month and the end of the year
        {
            day=1;            //Assign day to 1
            month=1;           //Assign month to 1
