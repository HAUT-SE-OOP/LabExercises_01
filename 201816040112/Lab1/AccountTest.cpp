...
int main()
{
   ...
   int DepoistAmount; // stores withdrawal amount read from user

   cout << "\nEnter depoist amount for account1: "; // prompt
   cin >> DepoistAmount; // obtain user input
   cout << "\nsave " << DepoistAmount
      << " to account1 balance\n\n";
   /* write code to withdraw money from account1 */
   ...
   cout << "\nEnter depoist amount for account2: "; // prompt
   cin >> DepoistAmount; // obtain user input
   cout << "\nsave " << DepoistAmount
      << " to account2 balance\n\n";
   /* write code to withdraw money from account2 */
    account2.credit(DepoistAmount);
   // display balances
   cout << "account1 balance: $" << account1.getBalance() << endl;
   cout << "account2 balance: $" << account2.getBalance()<< endl;
} // end main
