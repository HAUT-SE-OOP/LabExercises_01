...
Complex Complex::add( const Complex &right )
{
  ...
  return Complex(realPart,imaginaryPart); /* Write a statement to return a Complex object. Add
...
realPart-=right.realPart;
  imaginaryPart-=right.imaginaryPart;
return Complex(realPart,imaginaryPart);  /* Write a statement to return a Complex object. Subtract
