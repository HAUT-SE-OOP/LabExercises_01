...
//debit an amount from the account balance
void Account::debit(int amount)
{
    balance = balance - amount;//withdrawa amount from balance
}//end function debit
...
//juge the account balance's value
void Account::juge(int value)
{
    if(value < 0)
    {
