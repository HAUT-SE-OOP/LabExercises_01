...
int main()
{
   ...
   cout << "\nsubtracting " << withdrawalAmount
    ...
    account1.debit(account1.getBalance(),withdrawalAmount );/* write code to withdraw money from account1 */
   ...
   account2.debit(account2.getBalance(),withdrawalAmount );/* write code to withdraw money from account2 */
