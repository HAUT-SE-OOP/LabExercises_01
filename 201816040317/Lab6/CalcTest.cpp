...
int main()
{
   ...
   sc.answer= sc.divide( a, b );
   cout << "Dividing a by b yields " << division << endl;
   cout << "answer is :" <<sc.getAnswer()<<endl;
}
