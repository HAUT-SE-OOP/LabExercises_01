...
public:
   ...
   void setYearlySalary( int );/* Declare a set method for the employee's monthly salary */
   int getYearlySalary();/* Declare a get method for the employee's monthly salary */
   void Amount();
private:
   ...
   int yearlySalary;/* Declare an int data member for the employee's monthly salary */
}; // end class Employee
