...
{
    if(balance-withdraw>=0)//Determine whether the amount after withdrawal is greater than zero
        balance=balance-withdraw;//If greater than zero, the extraction is successful
    else
       cout<<"Debit amount exceeded account balance.\n"<<endl;//Otherwise,print"Debit amount exceeded account balance."
}
