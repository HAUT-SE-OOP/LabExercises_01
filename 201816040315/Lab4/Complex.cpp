...
Complex Complex::add( const Complex &right )
{
   /* Write a statement to return a Complex object. Add
      ...
      realPart +=right.realPart;//real part plus real part
      imaginaryPart += right.imaginaryPart;//imaginary part plus imaginary part
...
Complex Complex::subtract( const Complex &right )
{
   /* Write a statement to return a Complex object. Subtract
      ...
      realPart -= right.realPart;//real part subtract real part
      imaginaryPart -= right.imaginaryPart;//imaginary part subtract imaginary part
      return Complex(realPart,imaginaryPart);
