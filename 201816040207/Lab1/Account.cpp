...
void Account::detractprice(int price)
{
    if(balance==0)
    {
        cout<<"WANNING:you can not withdraw money from this account"<<endl<<endl;
    }
    else
        balance = balance - price;//detract price from account
}//end function detractprice
