...
Complex Complex::add( const Complex &right)
{
   /* Write a statement to return a Complex object. Add
      ...
      Complex b;
      b.imaginaryPart=right.imaginaryPart+imaginaryPart;
      b.realPart=right.realPart+realPart;
      return b;
} // end function add
...
Complex Complex::subtract( const Complex &right )
{
   /* Write a statement to return a Complex object. Subtract
      ...
      Complex b;
      b.imaginaryPart=imaginaryPart-right.imaginaryPart;
      b.realPart=realPart-right.realPart;
      return b;
