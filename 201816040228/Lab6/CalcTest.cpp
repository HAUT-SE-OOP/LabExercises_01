...
int main()
{
   ...
   //adds a and b through the SimpleCalculator object; assign the result to a variable named addition
   ...
   //divides a and b through the SimpleCalculator object; assign the result to a variable named division
