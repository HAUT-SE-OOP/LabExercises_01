...
string GradeBook::getInstructorName()//function to get the instructor name
{
...
void GradeBook::displayMessage()
{
   ...
   cout << "Welcome to the grade book for\n" << getCourseName() << "!"
      << endl;
   cout << "This course is presented by:" << getInstructorName() << endl;//output the instructor's name
