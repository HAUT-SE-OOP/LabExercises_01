...
int main()
{
   ...
   account1.debit(withdrawalAmount);//using debit function to deal with withdrawalAmount
   // display balances
   cout << "account1 balance: $" << account1.getBalance() << endl;
   cout << "account2 balance: $" << account2.getBalance() << endl;
   ...
   account2.debit(withdrawalAmount);//using debit function to deal with withdrawalAmount
   // display balances
   cout << "account1 balance: $" << account1.getBalance() << endl;
   cout << "account2 balance: $" << account2.getBalance() << endl;
} // end main
