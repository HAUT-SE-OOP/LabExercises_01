...
Complex Complex::add( const Complex &right )
{
   /* Write a statement to return a Complex object. Add
     ...
     return{realPart+right.realPart,imaginaryPart+right.imaginaryPart};//return real and imaginary part
...
Complex Complex::subtract( const Complex &right )
{
   /* Write a statement to return a Complex object. Subtract
      ...
      return{realPart-right.realPart,imaginaryPart-right.imaginaryPart};//return real part and imaginary part
