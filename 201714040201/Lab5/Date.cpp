...
Date::~Date()
{
   cout<<"The destructor call was successful"<<endl;
}
...
void Date::addDate()//implement automatic date growth
{
    int y=monthDays();//judge the day and year
    if(day <y)//if the date is within this month day++;
        day++;
    ...
    if(month>12)//if month greater than 12,year++;
    {
        month-=12;
        year++;
    }
