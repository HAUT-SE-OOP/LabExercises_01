...
int main()
{
   ...
   account1.exceed(withdrawalAmount);//compare the withdrawalAmount with the account1 balance
   ...
   account2.exceed(withdrawalAmount);//compare the withdrawalAmount with the account2 balance
