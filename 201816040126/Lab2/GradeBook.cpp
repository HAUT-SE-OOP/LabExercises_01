...
void GradeBook::setInstructorName( string instructor)//function to set instructor's name
{
    instructorName = instructor;
}/* write code to define a get member function for the instructor's name */

string GradeBook::getInstructorName()//function to get instructor's name
{
