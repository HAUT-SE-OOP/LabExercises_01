...
public:
   ...
   void setInstructorName( string );/* write code to declare a get function for the instructor's name */
   string getInstructorName();/* write code to declare a set function for the instructor's name */
