...
int main()
{
   ...
   cout << "\nsubtracting " << withdrawalAmount
      ...
      account1.debit(withdrawalAmount);//withdraw money from account1
   ...
   cout << "\nsubtracting " << withdrawalAmount
      ...
      account2.debit(withdrawalAmount);//withdraw money from account2

   int account2balance = account2.getBalance();
   account2.juge(account2balance);//juge the value of accoun2 balance
   account2.credit(withdrawalAmount);//add amount to account2
